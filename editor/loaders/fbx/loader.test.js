...
describe("fbx Loader", () => {
  test("loading cube.fbx", () => {
    ...
    const {gl, sceneManager} = createSceneContextForTests(sceneNodeFxbCube);
...
test("unpacked polygon indexes mapped to triangle indexes", () => {
  const vertices = [
    -0.0882214605808258,
    1.9469735622406006,
    -2.0171525478363037, // v0
    -0.0882214605808258,
    -0.05302649736404419,
    -2.0171525478363037, // v1
    -0.0882214605808258,
    1.9469735622406006,
    -0.01715238019824028, // v2
    -0.0882214605808258,
    -0.05302649736404419,
    -0.01715238019824028, // v3
    -2.088221311569214,
    1.9469735622406006,
    -2.0171525478363037, // v4
    -2.088221311569214,
    -0.05302649736404419,
    -2.0171525478363037, // v5
    -2.088221311569214,
    1.9469735622406006,
    -0.01715238019824028, // v6
    -2.088221311569214,
    -0.05302649736404419,
    -0.01715238019824028, // v7
  ];
  ...
  const remappedPolygonIndexes = polygonVertexIndexesToRenderIndexes(
    polygonVertexIndex,
    [2, 3, 1, 12, 5, 16, 13, 6]
  );
