...
function multiplyRotationMatrix(dest, a, b) {
  ...
  dest[0] = [
    multiplyString(a00, b00),
    multiplyString(a01, b10),
    multiplyString(a02, b20),
    multiplyString(a03, b30),
  ];
  dest[1] = [
    multiplyString(a00, b01),
    multiplyString(a01, b11),
    multiplyString(a02, b21),
    multiplyString(a03, b31),
  ];
  dest[2] = [
    multiplyString(a00, b02),
    multiplyString(a01, b12),
    multiplyString(a02, b22),
    multiplyString(a03, b32),
  ];
  dest[3] = [
    multiplyString(a00, b03),
    multiplyString(a01, b13),
    multiplyString(a02, b23),
    multiplyString(a03, b33),
  ];

  // Second row = second row of B times all columns of A
  dest[4] = [
    multiplyString(a10, b00),
    multiplyString(a11, b10),
    multiplyString(a12, b20),
    multiplyString(a13, b30),
  ];
  dest[5] = [
    multiplyString(a10, b01),
    multiplyString(a11, b11),
    multiplyString(a12, b21),
    multiplyString(a13, b31),
  ];
  dest[6] = [
    multiplyString(a10, b02),
    multiplyString(a11, b12),
    multiplyString(a12, b22),
    multiplyString(a13, b32),
  ];
  dest[7] = [
    multiplyString(a10, b03),
    multiplyString(a11, b13),
    multiplyString(a12, b23),
    multiplyString(a13, b33),
  ];

  // Thrid row = third row of B times all columns of A
  dest[8] = [
    multiplyString(a20, b00),
    multiplyString(a21, b10),
    multiplyString(a22, b20),
    multiplyString(a23, b30),
  ];
  dest[9] = [
    multiplyString(a20, b01),
    multiplyString(a21, b11),
    multiplyString(a22, b21),
    multiplyString(a23, b31),
  ];
  dest[10] = [
    multiplyString(a20, b02),
    multiplyString(a21, b12),
    multiplyString(a22, b22),
    multiplyString(a23, b32),
  ];
  dest[11] = [
    multiplyString(a20, b03),
    multiplyString(a21, b13),
    multiplyString(a22, b23),
    multiplyString(a23, b33),
  ];

  // Fourth row = fourth row of B times all columns of A
  dest[12] = [
    multiplyString(a30, b00),
    multiplyString(a31, b10),
    multiplyString(a32, b20),
    multiplyString(a33, b30),
  ];
  dest[13] = [
    multiplyString(a30, b01),
    multiplyString(a31, b11),
    multiplyString(a32, b21),
    multiplyString(a33, b31),
  ];
  dest[14] = [
    multiplyString(a30, b02),
    multiplyString(a31, b12),
    multiplyString(a32, b22),
    multiplyString(a33, b32),
  ];
  dest[15] = [
    multiplyString(a30, b03),
    multiplyString(a31, b13),
    multiplyString(a32, b23),
    multiplyString(a33, b33),
  ];
